...
/**
 * Component representing the downloadable logo card
 **/
export default function LogoCard() {
  const downloadSvg = () => downloadTextFile(buildLogoSvg(), LOGO_FILE_NAME, 'image/svg+xml');
    ...
    <motion.section
      ...
      <div className='flex flex-col gap-2.5'>
        <button
          type='button'
          onClick={downloadSvg}
          className='flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-500 px-4 py-2.5 text-sm font-semibold text-white transition-colors duration-150 ease-out hover:bg-indigo-600'>
