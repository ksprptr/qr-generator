...
/**
 * Easter egg: a Pikachu peeking from the left edge — hover pulls it out, clicking it shouts
 **/
        ...
        <AnimatePresence>
          {burst && (
            <motion.div
              ...
              className='pointer-events-none absolute -top-2 left-8 z-10 text-base font-extrabold text-nowrap text-yellow-400 drop-shadow-[0_1px_0_rgba(0,0,0,0.35)] dark:text-yellow-300'>
          ...
          {burst &&
            SPARKS.map((spark, index) => (
              <motion.span
                ...
                className='pointer-events-none absolute top-6 left-10 z-10 text-sm select-none'>
                ⚡
              </motion.span>
            ))}
        </AnimatePresence>
        ...
        <AnimatePresence>
          {burst && (
            <motion.div
              ...
              className='pointer-events-none absolute bottom-4 left-4 h-24 w-24 rounded-full bg-yellow-300/50 blur-2xl'
            />
          )}
        </AnimatePresence>
